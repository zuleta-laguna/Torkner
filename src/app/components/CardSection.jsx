...
function CardSection() {
  return (
    <section className="p-28 w-full text-white max-[8340px]:p-2 max-[834px]:mt-20 max-[834px]:h-[1000px]">
    <div className="w-full flex gap-3 max-[834px]:flex-col">
      <div className="w-1/2 h-80 rounded-2xl bg-[#171B29] p-7 max-[834px]:w-full max-[834px]:min-h-[400px] ">
      ...
      <div className="w-1/2 h-80 rounded-2xl self-end bg-[#171B29] p-7 max-[834px]:w-full max-[834px]:min-h-[400px]">
